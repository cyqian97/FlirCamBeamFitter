...
def print_value_node(node, level):
    ...
    try:
        ...
        display_name = node_value.GetName()
...
def print_string_node(node, level):
    ...
    try:
        ...
        display_name = node_string.GetName()
...
def print_integer_node(node, level):
    ...
    try:
        ...
        # Get display name
        # display_name = node_integer.GetName()
        display_name = node_integer.GetName()
...
def print_float_node(node, level):
    ...
    try:
        ...
        # Get display name
        display_name = node_float.GetName()
...
def print_boolean_node(node, level):
    ...
    try:
        ...
        # Get display name
        display_name = node_boolean.GetName()
...
def print_command_node(node, level):
    ...
    try:
        ...
        # Get display name
        display_name = node_command.GetName()
...
def print_enumeration_node_and_current_entry(node, level):
    ...
    try:
        ...
        # Get display name
        display_name = node_enumeration.GetName()
...
def print_category_node_and_all_features(node, level):
    ...
    try:
        ...
        display_name = node_category.GetName()
